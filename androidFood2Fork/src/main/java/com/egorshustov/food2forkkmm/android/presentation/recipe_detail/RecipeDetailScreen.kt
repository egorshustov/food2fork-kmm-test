...
import com.egorshustov.food2forkkmm.android.presentation.recipe_detail.components.LoadingRecipeShimmer
    ...
    AppTheme(
        ...
        when {
            state.recipe == null && state.isLoading -> {
                LoadingRecipeShimmer(imageHeight = RECIPE_IMAGE_BOX_HEIGHT.dp)
            }
